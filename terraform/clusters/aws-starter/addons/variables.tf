...
variable "state_key" {
  description = "Remote-state object key for the cluster stage. Leave empty to use the aws-starter default path."
  type        = string
  default     = ""
}
...
variable "cloud_provider" {
  description = "Cloud provider for platform overlay (aws for this directory)"
  type        = string
  default     = "aws"
